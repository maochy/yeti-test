...
\indent Extensive experiments were carried out to evaluate the performance of DSSR strategy. Every class was tested 30 times by random, random plus and DSSR strategy. The total number of experiments performed is 100 x 30 x 30 x 30 = 9000. Each class was evaluated by 1 lac test cases in each experiment so The total number of test cases in 9000 experiments are 9000 x 1000000 = 9000000000. The automated oracle used for all experiments was the defined exception of the language because of the absence of the contracts and assertions in the code under test.\\
