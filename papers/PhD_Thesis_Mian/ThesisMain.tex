...
\hypersetup{
   ...
   pdfkeywords = {phd, thesis, york, university, test strategies, automated testing, random},
...
\dedication{\input{ToWhom}}

%%inroduction
\ychapter{Introduction and Motivation}{Introduction and
Motivation}{\input{Introduction}}


%%literature review
\ychapter{Literature Review}{Literature
Review\label{CHAP:FIELDREV}}{\input{LiteratureReview_new}}%{\input{FieldReview}}
...
%  \put(80,-550){\includegraphics[width=7cm]{Woodcuts/univwoodcut}}
%\end{picture}
%}
