...
\begin{center}
\fontsize{18}{26}\selectfont {Acknowledgments} \\[0.5\baselineskip]    
\end{center}
\fontsize{12}{26}\selectfont {It would not be possible to achieve the project completion in such a short time without the help and support I received cheerfully from whole team of Rapita Systems Ltd. The working environment at Rapita Systems is highly motivational and inspirational.
...
\fontsize{11}{22}\selectfont {Automation of computer operations can be surprisingly effective and highly beneficial for any organisation. Its initial setup cost may be higher, however, a quick return on investment (QRI) outperforms that cost and brings the key benefits of cost reduction, productivity, availability, reliability and performance to any organisation.  Automation is particularly effective in the cases where nature of job is repetitive and performed on routine basis. These simple or complex manual jobs consume unnecessary time and provide an extra burden on the staff.  \\   
...
\indent \fontsize{11}{22}\selectfont {This section describe the step by step procedure of the system with the help of figure.}\ \


\begin{figure}[h]
\centering
\includegraphics[width=12cm]{rapitaSystems.png}
