...
Automated Discovery of Failure Domain+ (ADFD+) is a successor of our previously developed technique Automated Discovery of Failure Domain (ADFD). ADFD is an automated framework that finds the failures, their domains and present these on a graphical chart\cite{ADFD}. 
