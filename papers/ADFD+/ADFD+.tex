...
%{\it Roadmap:} Section II presents ADFD+ strategy. Section III describes how Daikon works. Section IV presents the -------- and its properties. Section V evaluates our approach through several two dimensional programs. Section VI presents the threats to validity of our approach. Section VII presents related work. We conclude in Section VIII.
...
\section{Automated Discovery of Failure Domain+}\label{sec:dssr}
