...
\begin{table}[h]
\caption{Table depicting values of x and y arguments responsible for forming point, block and strip failure domain in Figure 4(a), Figure 4(b) and Figure= 4(c) respectively}
\bigskip
\centering
...
\begin{table}[h]
\caption{Table depicting values of x and y arguments responsible for forming point, block and strip failure domain in Figure 5(a), Figure 5(b) and Figure= 5(c) respectively}
\centering
{\renewcommand{\arraystretch}{1.3}
\begin{tabular}{|l|l|l|}
\hline
...
The results are split in to two sections for convenience. The first section (\ref{adfd+_results}) contains results of the experiments performed by ADFD+ strategy and the second section (\ref{daikon_results}) contains results of Daikon on one and two dimensional numerical programs.  
