...
\textbf{3}					& \textbf{Apriori}			&\textbf{292}	& \textbf{3}&	\textbf{4}	&\textbf{3}	& \textbf{0.31}			& \textbf{3}& \textbf{4} 		& \textbf{3}& \textbf{0.43}	& \textbf{3}	& \textbf{4}	& \textbf{3}	&\textbf{0.47}\\      
