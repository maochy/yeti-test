...
\begin{figure}[ht]
\centering
\includegraphics[width=8.2cm,height=6cm]{chapter5/ADFD_Diagram1.png}
...
\begin{center}
%\centring
\includegraphics[width=12cm,height=6.6cm]{chapter5/ADFD_front_end.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=8.2cm,height=3.5cm]{chapter5/pointDomainOneArgument.png}
...
\includegraphics[width=6cm,height=4cm]{chapter5/PFDOne.png}
\label{fig:PFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter5/PFDTwo.png}
\label{fig:PFDTwo}
}
...
\subfigure[One dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter5/BFDOne.png}
\includegraphics[width=6cm,height=4cm]{chapter5/BFDOne.png}
\label{fig:BFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter5/BFDTwo.png}
\label{fig:BFDTwo}
}
...
\subfigure[One dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter5/SFDOne.png}
\label{fig:SFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter5/SFDTwo.png}
\label{fig:SFDTwo}
}
