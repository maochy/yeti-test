...
\begin{figure}[ht]
\centering
\includegraphics[width=8.2cm,height=5cm]{chapter5/pointDomainOneArgument.png}
\caption{ADFD strategy plotting pass and fault domain of the given class}
\label{fig:ADFD-plot}
\end{figure}
...
\includegraphics[width=7cm,height=4.5cm]{chapter5/PFDOne.png}
\label{fig:PFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=7cm,height=4.5cm]{chapter5/PFDTwo.png}
\label{fig:PFDTwo}
}
...
\centering
\subfigure[One dimension module]{
\includegraphics[width=7cm,height=4.5cm]{chapter5/BFDOne.png}
\label{fig:BFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=7cm,height=4.5cm]{chapter5/BFDTwo.png}
\label{fig:BFDTwo}
}
...
\centering
\subfigure[One dimension module]{
\includegraphics[width=7cm,height=4.5cm]{chapter5/SFDOne.png}
\label{fig:SFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=7cm,height=4.5cm]{chapter5/SFDTwo.png}
\label{fig:SFDTwo}
}
