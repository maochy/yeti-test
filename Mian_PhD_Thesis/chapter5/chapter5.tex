...
The ADFD strategy is also implemented implemented in YETI. Please refer to Chapter~\ref{chap:yeti_3} for details on YETI. In this section we give a brief overview of implementation of ADFD strategy in YETI and illustrate it with the help of an example. 
\bigskip
\begin{figure}[h]
\centering
