...
\includegraphics[width=6cm,height=4cm]{chapter4/PFDOne.png}
\label{fig:PFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter4/PFDTwo.png}
\label{fig:PFDTwo}
}
...
\subfigure[One dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter4/BFDOne.png}
\label{fig:BFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter4/BFDTwo.png}
\label{fig:BFDTwo}
}
...
\subfigure[One dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter4/SFDOne.png}
\label{fig:SFDOne}
}
\subfigure[Two dimension module]{
\includegraphics[width=6cm,height=4cm]{chapter4/SFDTwo.png}
\label{fig:SFDTwo}
}
