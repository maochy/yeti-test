...
2. $\quad$ $\quad$$\quad$ $\quad$\textbf{if} currentFailures $\textgreater$ oldFailures \newline
3. $\quad$ $\quad$$\quad$ $\quad$$\quad$ oldFailures $\leftarrow$ currentFailures \newline
4. $\quad$ $\quad$$\quad$ $\quad$$\quad$ \textbf{if} type.isPrimitiveType == true\newline
5. $\quad$ $\quad$$\quad$ $\quad$$\quad$ $\quad$value $\leftarrow$ value(type)\newline
6. $\quad$ $\quad$$\quad$ $\quad$$\quad$ $\quad$value $\leftarrow$ value + 3\newline
7. $\quad$ $\quad$$\quad$ $\quad$$\quad$ $\quad$\textbf{for} n $\neq$ 0\newline
8. $\quad$ $\quad$$\quad$ $\quad$$\quad$ $\quad$$\quad$list $\leftarrow$ value - n\newline
