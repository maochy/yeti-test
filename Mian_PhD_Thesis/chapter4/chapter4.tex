...
In this chapter we assume that failure domains are contiguous for sufficient number of classes. Based on this assumption, we devised the Dirt Spot Sweeping %\footnote{The name refers to the cleaning robots strategy which insists on places where dirt has been found in large amount.} 
