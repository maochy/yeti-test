...
\subsection{Software Testing Summary}
...
\begin{figure}[h]
	\centering
	\centerline{\includegraphics[width=16cm, height=12cm]{chapter2/TestEra.png}}
...
\begin{figure}[H]
	\centering
	%\centerline{\includegraphics[width=16cm, height=16cm]{chapter2/softwareTestingFlow.png}}
	\centerline{\includegraphics[width=15cm, height=14cm]{chapter2/Tools.png}}
