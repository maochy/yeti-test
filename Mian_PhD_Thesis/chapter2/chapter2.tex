...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm, height=2.5cm ]{chapter2/randomTesting.jpg}
...
\subsection{Genuine and Failure-domain}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=13cm, height=5.7cm ]{chapter2/pointblockstrip.jpg}
	\caption{Patterns of failure causing inputs~\cite{chan1996proportional}}
	\label{fig:patterns2}
\end{figure}
