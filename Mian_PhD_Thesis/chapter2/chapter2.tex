...
Some commonly used white-box testing techniques are stated below:
...
\begin{wrapfigure}{r}{0.35\textwidth}
  ...
  \vspace{-18pt}
\end{wrapfigure}
In black-box or functional testing, the testers do not need to know about internal code structure of the SUT. Test cases are derived from the software specifications and test passes if the result is according to expected output~\cite{beizer1995black}. \\*
Some commonly used black-box testing techniques are stated below:
