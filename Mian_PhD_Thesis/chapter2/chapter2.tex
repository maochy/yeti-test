...
\includegraphics[width=3.4cm,height=3.4cm]{chapter2/point.png}
\label{fig:point}
}
\subfigure[Block domain]{
\includegraphics[width=3.4cm,height=3.4cm]{chapter2/block.png}
\label{fig:block}
}
\subfigure[Strip domain]{
\includegraphics[width=3.4cm,height=3.4cm]{chapter2/strip.png}
\label{fig:strip}
}
\bigskip
