...
Chan et al.~\cite{chan1996proportional} observed that failure inducing inputs are contiguous and form certain geometrical patterns in the whole input domain. They divided them into point, block and strip patterns on the basis of their shape (Section~\ref{sec:artpatterns_2}). % put the failure domains section label in the preceeding reference.
