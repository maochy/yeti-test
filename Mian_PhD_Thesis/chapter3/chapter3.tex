...
\begin{figure}[ht]                                    
\centering
\includegraphics[width= 8cm,height=2.5cm]{chapter3/ART_Patterns.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm,height=2.2cm]{chapter3/block2.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm, height=12cm]{chapter3/flowchart1.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=4cm,height=5cm]{chapter3/hierarchy.pdf}
...
\begin{figure*}[ht]
\centering
\includegraphics[width=14cm]{chapter3/DssrImprove.png}
