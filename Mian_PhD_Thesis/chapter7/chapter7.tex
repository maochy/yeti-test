...
\begin{figure}[H]
\centering
\includegraphics[width= 15.5cm,height=8cm]{chapter7/adfdUpgraded.png}
...
Two of the enhancement in the technique are visible in the Figure~\ref{fig:adfdUpgraded}. It shows the block failure-domain with the help of graph and invariants. It further shows that the failure domain is caused by individual failures i.e. when the value the passing argument is -1, 0 or 1. The test case generated by YETI shows the type of failure and the first value that caused the failure. 
...
\begin{figure}[H]
\centering
\includegraphics[width= 15.5cm,height=4.5cm]{chapter7/daikon.png}
%\includegraphics[width= 8.5cm,height=7cm]{adfdPlus1.png}
%\includegraphics[width= 8.5cm,height=7cm]{adfdPlus2.png}
\bigskip
...
S\# & Class				& Invariants by ADFD+       								& Invariants by ADFD     										& Invariants by Manual								\\
\hline
2	& IntList						& I $\le$ -1, I $\ge$ -15		& I $\le$ -1, I $\ge$ -509							& I $\le$ -1, I $\ge$ -2147483648								  \\ 		
	&                                             & J = 0									& J =0														& J = 0		   															  \\
