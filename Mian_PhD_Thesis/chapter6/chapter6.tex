...
S. No& 	Project 	& Class				& Method 			    & Dim & 	 Failure 	&	 ADFD &	 ADFD+ 		&	 daikon 	&	 Human	\\
\hline
1	&	ant				& LeadPipeInputStream		& LeadPipeInputStream(i) 		& one	& 		& 			& 			& 			& \\ 
2	&	antlr			& BitSet				  		& BitSet.of(i,j)				& two	& & & & & \\ 
3	&	artofillusion		& ToolPallete			  		& ToolPalette(i,j)				& two	& & & & & \\ 
...
19	&	megamek		& AmmoType				& getMunitionsFor(i)			& one	&& & & & \\ 			
	&					& Board						& getTypeName(i)			& one	&& & & & \\ 
20	&	nekohtml		& HTMLEntities				& get(i)						& one	&& & & & \\ 
21	&	poi				& Variant					& getVariantLength(i)			& one	&& & & & \\ 
	&					& IntList						& IntList(i,j)					& two	&& & & & \\ 		
22	&	sunflow			& QMC						& halton(i,j)					& two	&& & & & \\ 
	&					& BenchmarkFramework		& BenchmarkFramework(i,j)	& two	&& & & & \\ 
	&					& IntArray					& IntArray(i)					& one	&& & & & \\ 	
23	&	trove			& TDoubleStack				& TDoubleStack(i)			& one	&& & & & \\ 
	&					& TIntStack					& TIntStack(i)				& one	&& & & & \\ 
	&					& TLongArrayList				& TLongArrayList(i)			& one	&& & & & \\ 
24	&	weka			& AlgVector					& AlgVector(i)				& one	&& & & & \\ 
	&					& BinarySparseInstance		& BinarySparseInstance(i)		& one	&& & & & \\ 
25	&	xerces			& SoftReferenceSymbolTable	& SoftReferenceSymbolTable(i)& one	&& & & & \\ 
	&					& SymbolHash				& SymbolHash(i)				& one	&& & & & \\ 
	&					& SynchronizedSymbolTable	& SynchronizedSymbolTable(i) & one	&& & & & \\ 
	&					& XMLChar					& isSpace(i)					& one	&& & & & \\ 
	&					& XMLGrammarPoolImpl		& XMLGrammarPoolImpl(i)		& one	&& & & & \\ 
	&					& XML11Char				& isXML11NCNameStart(i)		& one	&& & & & \\ 
	&					& AttributeList				& AttributeList(i)				& one	&& & & & \\ 
\hline
\end{tabular}
}
\bigskip
