...
\chapter{ADFD+: An Automatic Testing Technique for Finding and Presenting Failure domains}
\label{chap:ADFD+}
...
\includegraphics[width=8cm,height=6cm]{chapter6/PFDOne.png}
\label{fig:PFDOne6}
}
\subfigure[Block failure domain in one-dimension]{
\includegraphics[width=8cm,height=6cm]{chapter6/BFDOne.png}
\label{fig:BFDOne6}
}
\subfigure[Strip failure domain in one dimension]{
\includegraphics[width=8cm,height=6cm]{chapter6/SFDOne.png}
\label{fig:SFDOne6}
}
...
\includegraphics[width=8cm,height=6cm]{chapter6/PFDTwo.png}
\label{fig:PFDOne6}
}
\subfigure[Block failure domain in two-dimension]{
\includegraphics[width=8cm,height=6cm]{chapter6/BFDTwo.png}
\label{fig:BFDOne6}
}
\subfigure[Strip failure domain in two-dimension]{
\includegraphics[width=8cm,height=6cm]{chapter6/SFDTwo.png}
\label{fig:SFDOne6}
}
\caption{Pass and fail values of plotted by ADFD+ in three different cases of two-dimension programs}
