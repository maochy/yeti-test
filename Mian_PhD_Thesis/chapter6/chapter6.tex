...
\begin{figure}[htp]
\centering
\includegraphics[width= 11.5cm,height=10cm]{chapter6/adfdPlusWorkflow.png}
\bigskip
...
At the moment there are seven different random strategies including our previously developed DSSR and ADFD strategies. ADFD$^+$ strategy is also to this section by extending the $YetiADFDStrategy$ as shown in \ref{fig:hierarchyofADFDPlus}. Please see Chapter \ref{chap:yeti_3} for more details about YETI.
